...
const EmailVerification = () => {
  ...
  // Default to +1
  const { loading, verifyEmailAndCreateAccount, sendVerificationCode,toast } = useAuth();
  ...
  const handleVerifyAndCreateAccount = async (e) => {
    ...
    if (password !== confirmPassword) {
      setMistake("Les mots de passe ne sont pas identiques.")
      toast({
        title: "Erreur",
          ...
          <form onSubmit={handleVerifyAndCreateAccount}>
            <Stack spacing={4}>
              ...
              <FormControl isRequired>
               ...
               {mistake&&<Text color={"red.400"}>{mistake}</Text>}
               <Text >md ex:"ldoIOHTZ$df554"</Text>
               <FormControl isRequired>
